                                                                      ...
                                                                      child: Stack(
                                                                          ...
                                                                          children: <
                                                                            ...
                                                                            Positioned(
                                                                                ...
                                                                                left: 0,
                                                                                width: 320,
                                                                                child: Padding(padding: const EdgeInsets.all(20.0), child: Text(f.title, maxLines: 4, style: const TextStyle(color: Colors.white, fontSize: 21, fontWeight: FontWeight.bold)))),
                                                                          ])),
                                                                  Container(
                                                                    padding: const EdgeInsets
                                                                            .only(
                                                                  ...
                                                                  splashColor: Theme.of(context)
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        milliseconds:
                                                                            150));*/
                                                                        Utility()
                                                                            .launchInBrowser(Uri.parse(f.link));
                                                                      },
                                                                      child:
                                                                          Center(
                                                                        child:
