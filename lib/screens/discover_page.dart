                                                                      ...
                                                                      Container(
                                                                          ...
                                                                          child: Stack(
                                                                              ...
                                                                              children: <Widget>[
                                                                                ...
                                                                                Positioned(bottom: 0, left: 0, width: 320, child: Padding(padding: const EdgeInsets.all(20.0), child: Text(f.title, maxLines: 4, style: const TextStyle(color: Colors.white, fontSize: 21, fontWeight: FontWeight.bold)))),
                                                                              ])),
                                                                      Container(
                                                                        padding: const EdgeInsets.only(
                                                                            left:
